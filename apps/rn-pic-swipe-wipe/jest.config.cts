...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@mas/rn/hooks$': '<rootDir>/libs/react-native/hooks/src/index.ts',
    '^@mas/rn/hooks/(.*)$': '<rootDir>/libs/react-native/hooks/src/$1',
    '^@mas/rn/services$': '<rootDir>/libs/react-native/services/src/index.ts',
    '^@mas/rn/services/(.*)$': '<rootDir>/libs/react-native/services/src/$1',
    '^@mas/rn/store$': '<rootDir>/libs/react-native/store/src/index.ts',
    '^@mas/rn/store/(.*)$': '<rootDir>/libs/react-native/store/src/$1',
    '^@mas/rn/database$': '<rootDir>/libs/react-native/database/src/index.ts',
    '^@mas/rn/database/(.*)$': '<rootDir>/libs/react-native/database/src/$1',
    '^@mas/shared/config$': '<rootDir>/libs/shared/config/src/index.ts',
    '^@mas/shared/config/(.*)$': '<rootDir>/libs/shared/config/src/$1',
