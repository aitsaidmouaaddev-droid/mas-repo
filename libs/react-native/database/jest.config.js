module.exports = {
  displayName: '@mas/rn-database',
  preset: 'jest-expo',
  verbose: true,
  rootDir: '../../../',
  roots: ['<rootDir>/libs/react-native/database'],
  ...
  moduleNameMapper: {
    ...
    '^@mas/mas-sqlite$': '<rootDir>/libs/shared/mas-sqlite/src/index.ts',
  },
  transform: {
    '\\.[jt]sx?$': [
      'babel-jest',
  ...
  coverageDirectory: '<rootDir>/coverage/libs/react-native/database',
};
